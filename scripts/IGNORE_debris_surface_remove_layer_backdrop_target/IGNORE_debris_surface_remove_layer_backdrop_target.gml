...
function IGNORE_debris_surface_remove_layer_backdrop_target() {
	...
	var region = global.all_debris_surface_regions[@ global.debris_backdrop_regionTarget];
	region.hasBeenInitialised = true;
