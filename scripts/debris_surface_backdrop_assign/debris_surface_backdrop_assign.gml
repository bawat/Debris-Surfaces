...
function debris_surface_backdrop_assign(argument0) {

	global.debris_backdrop_layerName = argument0;
	...
	layer_script_begin(lay_id, debris_surface_set_layer_backdrop_target);
	layer_script_end(lay_id, debris_surface_remove_layer_backdrop_target);
